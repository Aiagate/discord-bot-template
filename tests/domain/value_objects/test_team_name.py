...
def test_team_name_repr() -> None:
    ...
    team_name = TeamName.from_primitive("Alpha Team").unwrap()
...
def test_team_name_equality() -> None:
    ...
    team_name1 = TeamName.from_primitive("Alpha Team").unwrap()
    team_name2 = TeamName.from_primitive("Alpha Team").unwrap()
...
def test_team_name_inequality() -> None:
    ...
    team_name1 = TeamName.from_primitive("Alpha Team").unwrap()
    team_name2 = TeamName.from_primitive("Beta Team").unwrap()
    assert team_name1 != team_name2
